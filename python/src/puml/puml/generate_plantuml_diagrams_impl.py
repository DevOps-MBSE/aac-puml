...
def before_puml_component_check(
    ...
    # TODO: configure and call the check before command using puml-component command inputs
    status = ExecutionStatus.GENERAL_FAILURE
    messages: list[ExecutionMessage] = []
    error_msg = ExecutionMessage(
        "The Check AaC check before handling for the puml-component command has not been implemented yet.",
        MessageLevel.ERROR,
        None,
        None,
    )
...
def after_puml_component_generate(
    ...
    messages: list[ExecutionMessage] = []
    error_msg = ExecutionMessage(
        "The Generate generate after handling for the puml-component command has not been implemented yet.",
        MessageLevel.ERROR,
        None,
        None,
    )
...
def after_puml_sequence_generate(
    ...
    messages: list[ExecutionMessage] = []
    error_msg = ExecutionMessage(
        "The Generate generate after handling for the puml-sequence command has not been implemented yet.",
        MessageLevel.ERROR,
        None,
        None,
    )
...
def after_puml_object_generate(
    ...
    messages: list[ExecutionMessage] = []
    error_msg = ExecutionMessage(
        "The Generate generate after handling for the puml-object command has not been implemented yet.",
        MessageLevel.ERROR,
        None,
        None,
    )
...
def after_puml_requirements_generate(
    ...
    messages: list[ExecutionMessage] = []
    error_msg = ExecutionMessage(
        "The Generate generate after handling for the puml-requirements command has not been implemented yet.",
        MessageLevel.ERROR,
        None,
        None,
    )
